...
export const ErrorModal = ({isOpen, errorMessage, errorType, closeErrorDialog, trackOfferLimit, participationLimit}) => {
    ...
    return (
        <Modal isOpen = {isOpen} centered>
            ...
            <ModalBody>
              {
                errorType === 'registrationOff' && (
                  <p>
                    Даты новых мероприятий доступны по&nbsp;
                    <a style={{ cursor: 'pointer', color: '#333333', fontWeight: 'bold'}} href="https://vk.com/@rnmmusicparty-raspisanie-music-party" target="_blank">
                      ссылке
                    </a>
                  </p>
                )
